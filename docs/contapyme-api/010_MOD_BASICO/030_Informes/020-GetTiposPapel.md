...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/030_Informes/020-GetTiposPapel.html

Â¿CÃ³mo generar informes en el sistema?

GetTiposPapel (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de retornar el listado de tipos de papel que se pueden usar para generar algunos informes del sistema.

#### Resultado

Retorna un Json con el listado de tipos de papel en los que se pueden generar los informes del sistema.
...
var URLFuncion = '/datasnap/rest/TCatPlanCuentas/"GetTiposPapel"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/020-GetTiposPapel.pdf)
...
{
"codigo": "1",
"nombre": "Papel tamaÃ±o carta hoja completa"
},
{
"codigo": "2",
"nombre": "Papel tamaÃ±o carta media hoja"
}
]
}
}
...
| respuesta | JSON | Json que contiene en su interior el arreglo de objetos “datos” que se describe a continuación:  **codigo (varchar)**: Código del tipo de papel **nombre (varchar)**: Nombre del tipo de papel |
