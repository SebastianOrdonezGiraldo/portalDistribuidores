...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/040_Cat_Empresas/010-GetListaEmpresas.html

Â¿CÃ³mo verificar la lista de empresas?

GetListaEmpresas (datajson, controlkey, iapp, random) : json
...
Función encargada de retornar la información de las empresas de trabajo registradas en el sistema.

#### Resultado

Retorna un Json con la lista de empresas de trabajo registradas en el sistema.
...
| --- | --- | --- | --- |
| dataJSON | JSON | Función encargada de retornar la información de las empresas de trabajo registradas en el sistema. | {} |
...
var URLFuncion = '/datasnap/rest/TCatEmpresas/"GetListaEmpresas"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/010-GetListaEmpresas.pdf)
