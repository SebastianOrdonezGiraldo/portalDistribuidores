...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/040_Cat_Empresas/020-GetListaSedes.html

Â¿CÃ³mo verificar la lista por sedes?

GetListaSedes (datajson, controlkey, iapp, random) : json
...
Función encargada de retornar el código y nombre de todas las sedes asociadas a la empresa de trabajo a la que el usuario está conectado.

#### Resultado

Retorna un json con la informaciÃ³n de todas las sedes de una empresa de trabajo.
...
var URLFuncion = '/datasnap/rest/TCatEmpresas/"GetListaSedes"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/020-GetListaSedes.pdf)
...
| respuesta | JSON | Json que contiene en su interior el arreglo de objetos “datos” el cual se descrito a continuación:  **isede (varchar)**: Código identificador de la sede. **nsede (varchar)**: Nombre de la sede. |
