...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/040_Cat_Empresas/040-GetLogoEmpresa.html

Â¿CÃ³mo obtener el logo de la empresa?

GetLogoEmpresa (datajson, controlkey, iapp, random) : TMemoryStream
...
Esta función es la encargada de retornar el logo que tiene la empresa de trabajo en el sistema.

#### Resultado

Retorna un TMemoryStream que contiene la imagen del logo de la empresa.
...
| --- | --- | --- | --- |
| dataJSON | JSON | No se requiere ningún dato, pues se retorna el logo de acuerdo a la empresa de trabajo a la que el usuario esté conectado. | {} |
...
var URLFuncion = '/datasnap/rest/TCatEmpresas/"GetLogoEmpresa"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/040-GetLogoEmpresa.pdf)
...
| respuesta | JSON | Json que contiene en su interior el objeto “datos” el cual se describe a continuación.  **iemp (varchar):** Código identificador de la empresa de trabajo. **nemp (varchar):** Nombre de la empresa de trabajo |
