...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/030_Cat_Operaciones/120-GetDocumentoOperacion.html

Â¿CÃ³mo verificar el documento en una operacion?

GetDocumentoOperacion (datajson, controlkey, iapp, random) : TMemoryStream
...
Retorna un TMemoryStream que contiene el documento PDF de una operaciÃ³n.
...
| --- | --- | --- | --- |
| dataJSON | JSON | Json que contiene en su interior la siguiente información:  **itdformato:** Código del tipo de documento de impresión en el cual se imprimirá la operación. Si este dato no es dado, se genera el PDF para el tipo de documento de impresión por defecto para la operación. (requerido).  **operacion:** Json que contiene los datos del documento a imprimir, en su interior contiene la siguiente información. **(requerido)**   - **inumoper:** Número de la operación a imprimir en formato PDF. **(requerido)** - i**tdoper:** Código del tipo de operación (requerido)  { "itdformato": 30, "operacion": { "inumoper": "28677", "itdoper": "ORD1" } } | |
...
var URLFuncion = '/datasnap/rest/TCatOperaciones/"GetCountOperaciones"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/120-GetDocumentoOperacion.pdf)
