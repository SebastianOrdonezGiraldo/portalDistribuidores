...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/030_Cat_Operaciones/100-GetValoresVentaCliente.html

Â¿CÃ³mo verificar los valores venta de los clientes?

GetValoresVentaCliente (datajson, controlkey, iapp, random) : json
...
Retorna un Json con la lista de precios y el vendedor por defecto para un tercero de tipo cliente.
...
var URLFuncion = '/datasnap/rest/TCatOperaciones/"GetValoresVentaCliente"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/100-GetValoresVentaCliente.pdf)
...
| respuesta | JSON | Json que contiene en su interior el objeto “datos” que se describe a continuación:  **initvendedor (varchar):** Código del vendedor por defecto asignado al cliente.  **ilistaprecios (integer)**: Código de la lista de precios por defecto asignada al cliente. |
