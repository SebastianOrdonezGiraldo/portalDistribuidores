...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/030_Cat_Operaciones/220-GetListaSaldosCxC.html

Â¿CÃ³mo verificar la lista de saldos por cartera?

GetListaSaldosCxC (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de retornar el listado de saldos de cuentas por cobrar que tiene un tercero. Es utilizada para registrar abonos a cuentas por cobrar.

#### Resultado

Retorna un Json con la lista de saldos de cuentas por cobrar de un tercero.
...
var URLFuncion = '/datasnap/rest/TCatOperaciones/"GetListaSaldosCxC"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/220-GetListaSaldosCxC.pdf)
