...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/030_Cat_Operaciones/160-GetListaMonedas.html

Â¿CÃ³mo verificar la lista de monedas?
...
Esta función es la encargada de retornar la información de las monedas configuradas en el sistema.

#### Resultado

Retorna un Json con la informaciÃ³n de las monedas que se manejan en el sistema.
...
var URLFuncion = '/datasnap/rest/TCatOperaciones/"GetListaMonedas"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/160-GetListaMonedas.pdf)
...
{
"imoneda": "10",
"nmonedaseleccion": "Peso",
"simbolo": "$"
},
{
"imoneda": "20",
"nmonedaseleccion": "Dolar",
"simbolo": "U$"
},
{
"imoneda": "30",
"nmonedaseleccion": "Euro",
"simbolo": "â¬"
}
]
}
...
| respuesta | JSON | Json que contiene en su interior el arreglo de objetos “datos” que se describe a continuación:  **imoneda (varchar)**: Código de la moneda **nmonedaseleccion (varchar)**: Nombre de la moneda. **simbolo (varchar)**: Símbolo que identifica la moneda. |
