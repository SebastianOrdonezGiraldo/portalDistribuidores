...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/030_Cat_Operaciones/020-GetCountOperaciones.html

Â¿CÃ³mo verificar la cuenta de operaciones?

GetCountOperaciones (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de retornar la cantidad de operaciones que hay registradas en el sistema, agrupadas por tipo de operación.
...
| --- | --- | --- | --- |
| dataJSON | JSON | En esta funciÃ³n este parÃ¡metro no se utiliza pero se define debido que puede ser requerido para usos futuros en el Agente CP. | {} |
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/020-GetCountOperaciones.pdf)
