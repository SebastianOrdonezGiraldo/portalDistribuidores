...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/030_Cat_Operaciones/050-GetListaCondicionesAdicionales.html

Â¿CÃ³mo obtener la lista de las condiciones adicionales?

GetListaCondicionesAdicionales (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de retornar el listado de condiciones adicionales que se pueden definir para las operaciones de pedido de un cliente y cotización. Este listado va asociado a las condiciones comerciales de un pedido o una cotización.

#### Resultado

Retorna un JSon con el listado de condiciones adicionales para las operaciones de pedido de un cliente y cotizaciÃ³n.
...
var URLFuncion = '/datasnap/rest/TCatOperaciones/"GetListaCondicionesAdicionales"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/050-GetListaCondicionesAdicionales.pdf)
...
{
"codigo": "0",
"descripcion": "Precio promocional por feria"
},
{
"codigo": "1",
"descripcion": "Descuento especial clientes VIP"
},
{
"codigo": "2",
"descripcion": "Precio especial navidad"
},
{
"codigo": "3",
"descripcion": "PromociÃ³n aniversario"
}
]
}
}
...
| respuesta | JSON | Json que contiene en su interior el arreglo de objetos “datos” que se describe a continuación:  **codigo (varchar):** Código identificador de la condición adicional **descripcion (varchar):** Nombre de la condición adicional. |
