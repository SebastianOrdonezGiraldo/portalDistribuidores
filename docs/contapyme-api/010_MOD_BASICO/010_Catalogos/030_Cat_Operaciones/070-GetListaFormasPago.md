...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/030_Cat_Operaciones/070-GetListaFormasPago.html

Â¿CÃ³mo obtener la lista de formas de pago?

GetListaFormasPago (datajson, controlkey, iapp, random) : json
...
Retorna un Json con la informaciÃ³n de las formas de pago para las operaciones de pedido de un cliente y cotizaciÃ³n.
...
var URLFuncion = '/datasnap/rest/TCatOperaciones/"GetListaFormasPago"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/070-GetListaFormasPago.pdf)
...
{
"codigo": "1",
"descripcion": "De contado contra entrega"
},
{
"codigo": "2",
"descripcion": "Pago a 30 dÃ­as"
},
{
"codigo": "3",
"descripcion": "Pago a 30, 60 y 90 dÃ­as"
},
{
"codigo": "4",
"descripcion": "Pago a 50% a la solicitud y 50% a la entrega "
},
{
"codigo": "5",
...
| respuesta | JSON | Json que contiene en su interior el arreglo de objetos “datos” que se describe a continuación:  **codigo (varchar)**: Código identificador de la forma de pago **descripcion (varchar)**: Nombre de la forma de pago. |
