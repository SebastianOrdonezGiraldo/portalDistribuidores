...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/030_Cat_Operaciones/060-GetListaFormasEnvio.html

Â¿CÃ³mo es el procedimiento de hacer un envÃ­o?

GetListaFormasEnvio (datajson, controlkey, iapp, random) : json
...
Retorna un Json con la informaciÃ³n de las formas de envÃ­o disponibles para las operaciones de pedido de un cliente y cotizaciÃ³n.
...
var URLFuncion = '/datasnap/rest/TCatOperaciones/"GetListaFormasEnvio"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/060-GetListaFormasEnvio.pdf)
...
{
"codigo": "1",
"descripcion": "Entregada en nuestro punto de venta"
},
{
"codigo": "2",
"descripcion": "EnvÃ­o por DHL nacional"
},
{
"codigo": "3",
"descripcion": "EnvÃ­o por servientrega nacional"
},
{
"codigo": "4",
"descripcion": "EnvÃ­o por DHL internacional"
},
{
"codigo": "5",
"descripcion": "EnvÃ­o por servientrega internacional"
}
]
}
}
...
| respuesta | JSON | Json que contiene en su interior el arreglo de objetos “datos” que se describe a continuación:  **codigo (varchar):** Código identificador de la forma de envío **descripcion (varchar):** Nombre de la forma de envío. |
