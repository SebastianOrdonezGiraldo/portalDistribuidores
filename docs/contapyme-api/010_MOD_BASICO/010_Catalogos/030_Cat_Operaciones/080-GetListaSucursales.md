...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/030_Cat_Operaciones/080-GetListaSucursales.html

Â¿CÃ³mo verificar la lista de sucursales?

GetListaSucursales (datajson, controlkey, iapp, random) : json
...
| --- | --- | --- | --- |
| dataJSON | JSON | Json que contiene en su interior la siguiente estructura:  **Init:** Código identificador del tercero principal de la operación y del cual se desea obtener el listado de “Otras direcciones” que tenga configuradas. | { "init": "81000630" } |
...
var URLFuncion = '/datasnap/rest/TCatOperaciones/"GetListaSucursales"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/080-GetListaSucursales.pdf)
...
{
"codigo": "1",
"descripcion": "Sucursal de occidente"
},
{
"codigo": "2",
"descripcion": "Sucursal de oriente"
}
]
}
}
...
| respuesta | JSON | Json que contiene en su interior el arreglo de objetos “datos” que se describe a continuación:  **codigo (varchar):** Código identificador de la sucursal **descripcion (varchar)**: Nombre de la sucursal. |
