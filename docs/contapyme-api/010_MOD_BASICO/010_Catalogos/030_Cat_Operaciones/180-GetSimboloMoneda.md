...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/030_Cat_Operaciones/180-GetSimboloMoneda.html

Â¿CÃ³mo verificar el simbolo de la moneda?

GetSimboloMoneda (datajson, controlkey, iapp, random) : json
...
Retorna un Json con el sÃ­mbolo de una moneda dada.
...
| --- | --- | --- | --- |
| dataJSON | JSON | Json que contiene en su interior la siguiente información.  **imoneda (varchar)**: código identificador de la moneda de la cual se desea obtener su símbolo. (requerido) | { "imoneda": "10" } |
...
var URLFuncion = '/datasnap/rest/TCatOperaciones/"GetSimboloMoneda"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/180-GetSimboloMoneda.pdf)
...
| respuesta | JSON | Json que contiene en su interior el objeto “datos” que se describe a continuación:  **simbolo (varchar)**: Símbolo definido en el sistema para la moneda enviada en la petición. |
