...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/100_Cat_Plan_cuentas/170-GetIngresoEgresoForICuenta.html

Â¿CÃ³mo obtener el tipo de concepto de liquidaciÃ³n de una cuenta?

GetIngresoEgresoForICuenta (datajson, controlkey, iapp, random) : json
...
Retorna un Json con la confirmaciÃ³n del tipo de concepto de liquidaciÃ³n para una cuenta.
...
unciÃ³n disponible desde ContaPyme/AgroWin VersiÃ³n 4 - Release 7.
...
| --- | --- | --- | --- |
| dataJSON | JSON | Json que contiene en su interior la siguiente estructura:  **itdcuenta (varchar):** identificador del tipo de cuenta. Las cuentas se clasifican en los siguientes tipos: Activo, Pasivo, Patrimonio, Ingresos, Egresos, De orden deudora, De orden acreedora. (requerido) | { "itdcuenta":"1" } |
...
var URLFuncion = '/datasnap/rest/TCatPlanCuentas/"GetIngresoEgresoForICuenta"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/170-GetIngresoEgresoForICuenta.pdf)
...
| respuesta | JSON | Json que contiene en su interior el objeto “datos” que se describe a continuación:  **itdconc (varchar):** Contiene “E” cuando el tipo de concepto de liquidación es en Egreso o “I” cuando el tipo de concepto de liquidación es en Ingreso. |
