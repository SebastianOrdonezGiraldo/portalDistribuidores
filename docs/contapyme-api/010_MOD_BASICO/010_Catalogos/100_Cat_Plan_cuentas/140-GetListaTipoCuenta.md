...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/100_Cat_Plan_cuentas/140-GetListaTipoCuenta.html

Â¿CÃ³mo obtener la lista de los tipos de cuenta?

GetListaTipoCuenta (datajson, controlkey, iapp, random) : json
...
Retorna un Json con los tipos de cuentas disponibles.
...
var URLFuncion = '/datasnap/rest/TCatPlanCuentas/"GetListaTipoCuenta"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET](PDFS/140-GetListaTipoCuenta.pdf)
...
{
"codigo": "6",
"descripcion": "De orden deudora"
},
{
"codigo": "7",
"descripcion": "De orden acreedora"
}
]
}
}
...
| respuesta | JSON | Json que contiene en su interior el arreglo de objetos “datos” que se describe a continuación:  **codigo (varchar):** código identificador del tipo de cuenta **descripcion (varchar):** nombre del tipo de cuenta. |
