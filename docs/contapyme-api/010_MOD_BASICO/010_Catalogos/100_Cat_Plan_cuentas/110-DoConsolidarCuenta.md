...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/100_Cat_Plan_cuentas/110-DoConsolidarCuenta.html

Â¿CÃ³mo consolidar una cuenta?

DoConsolidarCuenta (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de consolidar la información de una cuenta con otra, para poder llamar la función es necesario conocer el código de la cuenta origen y el código de la cuenta destino.

#### Resultado

Retorna un Json con la confirmaciÃ³n de la consolidaciÃ³n de los datos de dos cuentas.
...
| --- | --- | --- | --- |
| dataJSON | JSON | Json que contiene en su interior la siguiente estructura:  **icuentaorigen:** Código de la cuenta que se quiere consolidar. (requerido) **icuentadestino:** Código de la cuenta con la cual se va a consolidar el icuentaorigen. (requerido). | { "icuentaorigen": "510515", "icuentadestino": "510516" } |
...
var URLFuncion = '/datasnap/rest/TCatPlanCuentas/"DoConsolidarCuenta"/';
...
var dataJSON = {
"icuentaorigen": "510515",
"icuentadestino": "510516"
};
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/110-DoConsolidarCuenta.pdf)
...
| respuesta | JSON | Json que contiene en su interior el objeto “datos” que se describe a continuación:  **consolidar (varchar):** contiene true cuando la cuenta se consolida satisfactoriamente y false cuando no se pudo consolidar. |
