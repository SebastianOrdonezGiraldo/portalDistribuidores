...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/100_Cat_Plan_cuentas/150-GetMaxNivelDetalle.html

Â¿CÃ³mo verificar el maximo nivel del detalle?

GetMaxNivelDetalle (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de retornar el número máximo de niveles que tiene la estructura del plan de cuentas en el sistema.

#### Resultado

Retorna un Json con el nÃºmero mÃ¡ximo de niveles que tiene la estructura del plan de cuentas.
...
var URLFuncion = '/datasnap/rest/TCatPlanCuentas/"GetMaxNivelDetalle"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/150-GetMaxNivelDetalle.pdf)
...
| respuesta | JSON | Json que contiene en su interior el objeto “datos” que se describe a continuación:  **maxnivel (integer)**: Número máximo de niveles que tiene la estructura del plan de cuentas en el sistema. |
