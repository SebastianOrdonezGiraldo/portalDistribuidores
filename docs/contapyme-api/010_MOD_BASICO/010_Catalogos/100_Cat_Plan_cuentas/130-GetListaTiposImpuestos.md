...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/100_Cat_Plan_cuentas/130-GetListaTiposImpuestos.html

Â¿CÃ³mo verificar el tipo de impuesto?
...
Esta función es la encargada de retornar el código y la descripción de los tipos de impuestos que se pueden asignar a una cuenta, esto aplica cuando la cuenta de tipo 3 “De impuestos”.
...
var URLFuncion = '/datasnap/rest/TCatPlanCuentas/"GetListaTiposImpuesto"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/130-GetListaTiposImpuestos.pdf)
...
| respuesta | JSON | Json que contiene en su interior el arreglo de objetos “datos” que se describe a continuación:  **codigo (varchar)**: código del tipo de impuesto. **descripcion (varchar)**: nombre del tipo de impuesto. |
