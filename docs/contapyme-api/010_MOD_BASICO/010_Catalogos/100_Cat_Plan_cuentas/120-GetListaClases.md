...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/100_Cat_Plan_cuentas/120-GetListaClases.html

Â¿CÃ³mo verificar la lista de clases?

GetListaClases (datajson, controlkey, iapp, random) : json
...
Retorna un Json con el listado de clases para una cuenta.
...
var URLFuncion = '/datasnap/rest/TCatPlanCuentas/"GetListaClases"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/120-GetListaClases.pdf)
...
{
"codigo": "4",
"descripcion": "De ajuste por inflaciÃ³n"
},
{
"codigo": "5",
"descripcion": "De nÃ³mina contable"
}
]
}
}
...
| respuesta | JSON | Json que contiene en su interior el arreglo de objetos “datos” que se describe a continuación:  **codigo (varchar)**: Código identificador de la clase **descripcion (varchar)**: Nombre de la clase. |
