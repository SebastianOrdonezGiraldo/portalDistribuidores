...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/100_Cat_Plan_cuentas/160-GetIsBalance.html

Â¿CÃ³mo verificar los ingresos del balance?

GetIsBalance (datajson, controlkey, iapp, random) : json
...
Esta funciÃ³n es la encargada de validar de acuerdo al tipo de cuenta si es de balance o no. Recibe el tipo de cuenta y retorna True si es de balance o false si no lo es.

#### Resultado

Retorna un Json con la confirmaciÃ³n de si una cuenta es de balance o no.
...
var URLFuncion = '/datasnap/rest/TCatPlanCuentas/"GetIsBalance"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/160-GetIsBalance.pdf)
...
| respuesta | JSON | Json que contiene en su interior el objeto “datos” que se describe a continuación:  **balance (varchar)**: Contiene True cuando la cuenta es de Balance y False cuando no lo es. |
