...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/010_Fun_Basicas/040-SetDatosTrabajo.html

Â¿CÃ³mo establecer los datos del trabajo?

SetDatosTrabajo (datajson, controlkey, iapp, random) : json
...
Función mediante la cual se pueden modificar los datos de trabajo para un usuario, los datos que se pueden actualizar son: Empresa de trabajo activa, fecha de trabajo, sede y lista de precios por defecto.

#### Resultado

Retorna un Json con la confirmaciÃ³n de la actualizaciÃ³n de los datos de trabajo.
...
| --- | --- | --- | --- |
| dataJSON | JSON | Json que contiene en su interior la siguiente estructura.  **iemp:** Identificador de la empresa a la cual se desea **cambiar** **fechatrabajo:** Fecha en la cual se registraran los datos en la **aplicación.** **isede:** Identificador de la sede a la cual se desea **cambiar.** **ilistaprecios:** código de la lista de precios a la cual se desea cambiar para seguir trabajando con ella. | { "iemp": "2", "fechatrabajo": "21/03/2014", "isede": "3", "ilistaprecios": "3" } |
...
var URLFuncion = '/datasnap/rest/TBasicoGeneral/"SetDatosTrabajo"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/040-SetDatosTrabajo.pdf)
...
| respuesta | JSON | Json que contiene en su interior el objeto datos el cual será descrito a continuación.  **modifico (varchar):** retorna true cuando los datos de trabajo se actualizan satisfactoriamente o false cuando no es posible actualizar. |
