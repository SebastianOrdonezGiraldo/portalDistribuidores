...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/010_Fun_Basicas/070-SetEmailFavoritos.html

Â¿CÃ³mo establecer el email favorito?

SetEmailFavoritos (datajson, controlkey, iapp, random): json
...
Esta función es la encargada de almacenar en la base de datos los emails favoritos de un usuario del sistema, un usuario puede tener uno o más emails favoritos.

#### Resultado

Retorna la confirmaciÃ³n del registro exitoso de los emails favoritos del usuario.
...
| --- | --- | --- | --- |
| dataJSON | JSON | Json que contiene en su interior la siguiente estructura.  **semailfavoritos:** Arreglo de objetos que contiene los siguientes datos: **nombre:** Nombre que identifica al email favorito **email:** Dirección de correo electrónico que se registra como favorita. (requerido). | { "semailfavoritos": [ { "nombre": "Institucional", "email": "pperez@mpcomputadores.com" }, { "nombre": "Email gerencia", "email": "gerencia@mpcomputadores.com" }, { "nombre": "Email contador", "email": "contabilidad@grupomp.com" } ] } |
...
var URLFuncion = '/datasnap/rest/TBasicoGeneral/"SetEmailFavoritos"/';
...
"email": "pperez@mpcomputadores.com"
},
{
"nombre": "Email gerencia",
"email": "gerencia@mpcomputadores.com"
},
{
"nombre": "Email contador",
"email": "contabilidad@grupomp.com"
}
]
};
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/070-SetEmailFavoritos.pdf)
...
| respuesta | JSON | Json que contiene en su interior el arreglo “datos” el cual se describe a continuación: **datos (arreglo):** contiene “true” cuando se registraron los emails favoritos satisfactoriamente y “false” cuando no se pudieron registrar. |
