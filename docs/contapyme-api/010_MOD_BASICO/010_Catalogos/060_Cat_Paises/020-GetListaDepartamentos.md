...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/060_Cat_Paises/020-GetListaDepartamentos.html

Â¿CÃ³mo verificar la lista de los departamentos?

GetListaDepartamentos(datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de retornar el código y nombre de todos los departamentos registrados en el sistema para un país.

#### Resultado

Retorna un Json con la informaciÃ³n de los departamentos de un paÃ­s.
...
| --- | --- | --- | --- |
| dataJSON | JSON | Json que contiene en su interior la siguiente estructura.  **ipais**: Código del país del cual se desean obtener sus departamentos. (requerido) | { "ipais": "169" } |
...
var URLFuncion = '/datasnap/rest/TCatPaises/"GetListaDepartamentos"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/020-GetListaDepartamentos.pdf)
...
| respuesta | JSON | Json que contiene en su interior el arreglo de objetos “datos” el cual se describe a continuación  **codigo (varchar)**: Código que tiene asignado el departamento en el sistema. **descripcion (varchar)**: Nombre del departamento. |
