...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/060_Cat_Paises/030-GetListaMunicipios.html

Â¿CÃ³mo verificar la lista de los municipios?

GetListaMunicipios(datajson, controlkey, iapp, random) : json
...
Retorna un json con la informaciÃ³n de los municipios de un departamento.
...
| --- | --- | --- | --- |
| dataJSON | JSON | Json que contiene en su interior la siguiente estructura.  **ipais**: Código del país al cual están asociados los municipios. (requerido) **idep:** Código del departamento al cual están asociados los municipios. (opcional) | { "ipais": "169", "idep": "17" } |
...
var URLFuncion = '/datasnap/rest/TCatPaises/"GetListaMunicipios"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/030-GetListaMunicipios.pdf)
...
| respuesta | JSON | Json que contiene en su interior el arreglo de objetos “datos” el cual se describe a continuación:  **codigo (varchar)**: Código que tiene asignado el municipio en el sistema **descripción (varchar):** Nombre del municipio |
