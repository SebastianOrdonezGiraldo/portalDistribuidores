...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/070_Tipos_Doc_Sop/010-GetListaTiposDocSop.html

Â¿CÃ³mo verificar la lista de los tipos de documentos?

GetListaTiposDocSop (datajson, controlkey, iapp, random) : json
...
Retorna un Json con el listado de tipos de documento de soporte creados en el sistema.
...
var URLFuncion = '/datasnap/rest/TCatTiposDocSop/"GetListaTiposDocSop"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/010-GetListaTiposDocSop.pdf)
