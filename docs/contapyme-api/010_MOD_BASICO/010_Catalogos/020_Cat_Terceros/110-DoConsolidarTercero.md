...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/020_Cat_Terceros/110-DoConsolidarTercero.html

Â¿CÃ³mo consolidar un tercero?

DoConsolidarTercero (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de consolidar la información de un tercero con otro, para poder llamar la función es necesario conocer el código del tercero origen y el código del tercero destino.

#### Resultado

Retorna un Json con la confirmaciÃ³n de la consolidaciÃ³n de los datos de dos terceros.
...
| --- | --- | --- | --- |
| dataJSON | JSON | Json que contiene en su interior la siguiente estructura.  **initorigen**: Código del tercero que se quiere consolidar. (requerido) **initdestino**: Código del tercero con el cual se va a consolidar el initorigen. (requerido) | { "initorigen": "1053799", "initdestino": "810000630" } |
...
var URLFuncion = '/datasnap/rest/TCatTerceros/"DoConsolidarTercero"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/110-DoConsolidarTercero.pdf)
...
| respuesta | JSON | Json que contiene en su interior el objeto “datos” que se describe a continuación:  **consolidar (varchar)**: contiene true cuando el tercero se consolida satisfactoriamente y false cuando no se pudo consolidar. . |
