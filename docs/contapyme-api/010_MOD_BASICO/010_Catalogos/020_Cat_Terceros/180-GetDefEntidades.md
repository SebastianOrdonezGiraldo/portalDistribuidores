...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/020_Cat_Terceros/180-GetDefEntidades.html

Â¿CÃ³mo obtener las entidades por defecto en ContaPyme/AgroWin?

GetDefEntidades (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de retornar la información de las diferentes entidades a las que puede estar afiliado un tercero de tipo empleado, entidades tales como: EPS, Pensión, Cesantías, ARL, entre otras.
...
var URLFuncion = '/datasnap/rest/TCatTerceros/"GetDefEntidades"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/180-GetDefEntidades.pdf)
...
{
"ialiasentidad": "EPS",
"naliasentidad": "Entidad promotora de salud"
},
{
"ialiasentidad": "PENSION",
"naliasentidad": "PENSION"
},
{
"ialiasentidad": "CESANTIAS",
"naliasentidad": "CESANTIAS"
}
]
}
}
...
| respuesta | JSON | Json que contiene en su interior el arreglo de objetos “datos” el cual se describe a continuación:  **ialiasentidad (varchar)**: Código que se asigna a la entidad dentro del sistema. **naliasentidad (varchar)**: Nombre de la entidad. |
