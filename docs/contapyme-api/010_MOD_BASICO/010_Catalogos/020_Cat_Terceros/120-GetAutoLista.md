...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/020_Cat_Terceros/120-GetAutoLista.html

Â¿CÃ³mo obtener la lista automatica?
...
Esta función se debe llamar en cada campo que presente un listado de datos; para saber cuáles campos son de tipo auto-lista, la función GetConfigCampos retornará en estos campos el parámetro “itdlista” en 1.
...
| --- | --- | --- | --- |
| dataJSON | JSON | Json que contiene en su interior la siguiente estructura.  **campo**: Nombre del campo de tipo auto-lista del cual se desea obtener el listado de valores que tiene registrados.  Los nombres de los campos se obtienen con la función GetConfigCampos de la clase TCatTerceros. (requerido).  **seccion:** Nombre de la sección en la que se encuentra el campo.  Los nombres de las secciones de información del catálogo de terceros se obtienen con la función GetConfigCampos de la clase TCatTerceros. (requerido).  **filtro:** Filtro que se debe aplicar para obtener el listado, este parámetro se debe enviar cuando en la función GetConfigCampos el parámetro “ncampofiltro” retorne algún valor. (opcional). | { "campo": "stratamiento", "secccion": "infobasica", "filtro": "" } |
...
var URLFuncion = '/datasnap/rest/TCatTerceros/"GetAutoLista"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/120-GetAutoLista.pdf)
