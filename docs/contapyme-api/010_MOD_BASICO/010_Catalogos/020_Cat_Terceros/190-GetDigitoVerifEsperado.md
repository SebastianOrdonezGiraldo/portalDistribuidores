...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/020_Cat_Terceros/190-GetDigitoVerifEsperado.html

Â¿CÃ³mo obtener el digito de verificaciÃ³n esperado?

GetDigitoVerifEsperado (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de calcular y retornar el dígito de verificación para el código de un tercero que se esté creando.

#### Resultado

Retorna un Json con el dÃ­gito de verificaciÃ³n sugerido para el cÃ³digo de un tercero dado
...
| --- | --- | --- | --- |
| dataJSON | JSON | Json que contiene en su interior la siguiente estructura.  **init:** Código del nuevo tercero del cual se desea obtener el dígito de verificación. (requerido) | { "init": "810000630" } |
...
var URLFuncion = '/datasnap/rest/TCatTerceros/"GetDigitoVerifEsperado"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/190-GetDigitoVerifEsperado.pdf)
...
| respuesta | JSON | Json que contiene en su interior el objeto “datos” que se describe a continuación:  **dvesperado (varchar):** dígito de verificación sugerido para el código de tercero dado. |
