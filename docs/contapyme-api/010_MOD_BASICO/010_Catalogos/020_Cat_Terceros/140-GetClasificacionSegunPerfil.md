...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/020_Cat_Terceros/140-GetClasificacionSegunPerfil.html

Â¿CÃ³mo clasificar segun el perfil?

GetClasificacionSegunPerfil (datajson, controlkey, iapp, random) : json
...
- Clasificación tributaria por defecto para personas naturales.
- Clasificación tributaria por defecto para personas jurídicas.
...
FunciÃ³n que retorna un Json con la clasificaciÃ³n tributaria por perfil.
...
| --- | --- | --- | --- |
| dataJSON | JSON | En esta funciÃ³n este parÃ¡metro no se utiliza pero se define debido que puede ser requerido para usos futuros en el Agente. | {} |
...
var URLFuncion = '/datasnap/rest/TCatTerceros/"GetClasificacionSegunPerfil"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/140-GetClasificacionSegunPerfil.pdf)
...
"datos": [{
"codigo": "1",
"descripcion": "ClasificaciÃ³n tributaria por defecto para personas naturales",
"clasificadores": "PN;RS"
},
{
"codigo": "2",
"descripcion": "ClasificaciÃ³n tributaria por defecto para personas jurÃ­dicas",
"clasificadores": "PJ;RC;AG"
}
]
}
}]
...
| respuesta | JSON | Json que contiene en su interior el arreglo de objetos “datos” el cual se describe a continuación:  **codigo (varchar)**: Código de la clasificación según perfil definida por defecto. **descripcion (varchar):** Nombre de la clasificación según perfil. **clasificadores (varchar)**: Códigos de los tipos de clasificación tributaria que se deben marcar cuando se le asigna a un tercero un perfil de clasificación tributaria por defecto. . |
