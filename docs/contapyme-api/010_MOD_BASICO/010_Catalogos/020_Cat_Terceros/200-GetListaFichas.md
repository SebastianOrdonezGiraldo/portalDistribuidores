...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/020_Cat_Terceros/200-GetListaFichas.html

Â¿CÃ³mo obtener la lista de fichas?

GetListaFichas (datajson, controlkey, iapp, random) : json
...
FunciÃ³n encargada de retornar el cÃ³digo y nombre de las fichas en las que se puede presentar la informaciÃ³n financiera del tercero. Con estas fichas se define la presentaciÃ³n que tendrÃ¡ la informaciÃ³n financiera del tercero en la aplicaciÃ³n ContaPyme mÃ³vil.

#### Resultado

Retorna un Json con la informaciÃ³n de las fichas en las que se puede presentar la informaciÃ³n financiera de un tercero.
...
var URLFuncion = '/datasnap/rest/TCatTerceros/"GetListaFichas"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/200-GetListaFichas.pdf)
...
{
"codigo": "1",
"descripcion": "Ficha movimiento mensual"
},
{
"codigo": "2",
"descripcion": "Ficha saldos mensuales"
},
{
"codigo": "3",
"descripcion": "Ficha segÃºn tipo de operaciÃ³n"
},
{
"codigo": "4",
"descripcion": "Ficha detalle de cuentas por cobrar"
},
{
"codigo": "5",
"descripcion": "Ficha detalle de cuentas por pagar"
},
{
"codigo": "6",
"descripcion": "Ficha detalle de vencimientos de CxC"
},
{
"codigo": "7",
"descripcion": "Ficha detalle de vencimientos de CxP"
}
]
}
}
...
| respuesta | JSON | Json que contiene en su interior el arreglo de objetos “datos” que se describe a continuación:  **codigo (varchar)**: Código de identificación de la ficha **descripcion (varchar)**: Nombre de la ficha de información financiera |
