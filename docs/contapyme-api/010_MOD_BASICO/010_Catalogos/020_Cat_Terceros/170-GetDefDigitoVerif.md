...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/020_Cat_Terceros/170-GetDefDigitoVerif.html

Â¿CÃ³mo obtener el digito de verificaciÃ³n por defecto para el tercero?

GetDefDigitoVerif (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de validar si el campo dígito de verificación es visible o no cuando se cree un tercero. El dígito de verificación va asociado al tipo de documento del tercero.

#### Resultado

Retorna un Json con la confirmaciÃ³n de si el digito de verificaciÃ³n es visible o no.
...
var URLFuncion = '/datasnap/rest/TCatTerceros/"GetDefDigitoVerif"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/170-GetDefDigitoVerif.pdf)
...
| respuesta | JSON | Json que contiene en su interior el objeto “datos” que se describe a continuación:  **visible (varchar)**: indica true cuando el dígito de verificación es visible y false cuando no lo es. |
