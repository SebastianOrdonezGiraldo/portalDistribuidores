...
> Fuente original: https://www.contapyme.com/api/010_MOD_BASICO/010_Catalogos/090_Cat_Observaciones_oprs/010-GetListaObservacionesOprs.html

Â¿CÃ³mo verificar la lista de las observaciones?

GetListaObservacionesOprs (datajson, controlkey, iapp, random) : json
...
Retorna un Json con el listado de observaciones para las operaciones creadas en el sistema.
...
var URLFuncion = '/datasnap/rest/TCatObservacionesOprs/"GetListaObservacionesOprs"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/010-GetListaObservacionesOprs.pdf)
...
{
"sgrupo": "",
"nobs": "ObservaciÃ³n DescripciÃ³n de productos",
"iobs": "DESCR"
},
{
"sgrupo": "",
