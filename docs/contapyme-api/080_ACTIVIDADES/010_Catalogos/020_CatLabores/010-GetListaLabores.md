...
> Fuente original: https://www.contapyme.com/api/080_ACTIVIDADES/010_Catalogos/020_CatLabores/010-GetListaLabores.html

Â¿CÃ³mo obtener la lista de labores?

GetListaLabores (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de retornar la información de un listado de labores registradas en el sistema. Retornará para cada labor la información que sea solicitada.  
Esta función se debe utilizar cuando se van mostrar las labores a manera de catálogo.

#### Resultado

Retorna un Json con el listado de labores creadas en el sistema.
...
var URLFuncion = '/datasnap/rest/TCatLabores/"GetListaLabores"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/010-GetListaLabores.pdf)
...
{
"ilabor": "001",
"nlabor": "Mantenimiento maquinaria"
},
{
"ilabor": "002",
"nlabor": "Mantenimiento elÃ©ctrico"
},
{
"ilabor": "003",
"nlabor": "Mantenimento vehÃ­culos"
}
]
}
}
