...
> Fuente original: https://www.contapyme.com/api/080_ACTIVIDADES/010_Catalogos/010_CatActividades/010-GetListaActividades.html

Â¿CÃ³mo obtener la lista de actividades?

GetListaActividades (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de retornar la información de un listado de actividades empresariales registradas en el sistema. Retornará para cada actividad la información que sea solicitada.  
Esta función se debe utilizar cuando se van mostrar las actividades a manera de catálogo.

#### Resultado

Retorna un Json con el listado de actividades empresariales creadas en el sistema.
...
var URLFuncion = '/datasnap/rest/TCatActividades/"GetListaActividades"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/010-GetListaActividades.pdf)
...
{
"iactividad": "0",
"nactividad": "Actividades generales"
},
{
"iactividad": "1",
"nactividad": "Capacitaciones"
},
{
"iactividad": "2",
"nactividad": "Mantenimiento"
}
]
}
}
