...
> Fuente original: https://www.contapyme.com/api/040_INVENTARIOS/025_Movimientos/030_GetListaElementosMovsPeriodo.html

Â¿CÃ³mo obtener la lista de un movimiento?

GetListaElementosMovsPeriodo (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de retornar el listado de productos que han sido movidos en un periodo dado, es decir, productos que han sido vendidos, comprados, trasladados entre otros.

#### Resultado

Retorna un Json con el listado de productos que han sido movidos en un perÃ­odo de tiempo.
...
var URLFuncion = '/datasnap/rest/TInventarios/"GetListaElementosMovsPeriodo"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/030_GetListaElementosMovsPeriodo.pdf)
...
{
"iproducto": "39211833",
"nrecurso": "VITAMINA C MANDARI CJA X 100",
"nunidad": "UN",
"smarca": "LA SANTE",
"sreffabricante": "7703763750184",
"qproducto": "15",
"mcosto": "6.000"
}
]
...
| respuesta | JSON | Json que contiene en su interior el arreglo de objetos “datos” los cuales serán descritos a continuación.  **datos (arreglo de objetos):** Cada objeto contiene en su interior la siguiente información:  **iproducto:** Código del producto que fue **movido.** **nrecurso:** Nombre del producto que fue **movido.** **nunidad:** Nombre de la unidad de medida del **producto.** **smarca:** Nombre de la marca del **producto** **sreffabricante:** Referencia del fabricante del **producto** **qproducto:** Cantidad de **producto.** **mcosto:** Costo del producto. |
