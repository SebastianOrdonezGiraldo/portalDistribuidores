...
> Fuente original: https://www.contapyme.com/api/040_INVENTARIOS/010_Catalogos/040_Bodegas/010-GetListaBodegas.html

Â¿CÃ³mo obtener la lista de las bodegas?

GetListaBodegas (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de retornar la información de las bodegas registradas en el sistema por cada empresa, para determinar de cual empresa se retornarán las bodegas, se toma la configuración de la empresa activa que tiene asignada el usuario.  
...
Retorna un JSon con el listado de bodegas registradas en el sistema.
...
var URLFuncion = '/datasnap/rest/TCatBodegas/"GetListaBodegas"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/010-GetListaBodegas.pdf)
...
{
"iinventario": "1",
"ninventario": "Bodega insumos/materiales"
},
{
"iinventario": "2",
"ninventario": "Bodega/Inventario mercancÃ­as"
}
]
}
}
