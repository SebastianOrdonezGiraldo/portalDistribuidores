...
> Fuente original: https://www.contapyme.com/api/040_INVENTARIOS/010_Catalogos/050_MetodosCalculoInv/010-GetListaMetodosCalculoInv.html

Â¿CÃ³mo obtener los metodos de calculo de la lista de inventario?

GetListaMetodosCalculoInv (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de retornar la información de un listado de métodos de cálculo (métodos para calcular el precio de los elementos de inventario) registrados en el sistema.   
Esta función retorna para cada método de cálculo la información que sea solicitada.

#### Resultado

Retorna un Json con el listado de mÃ©todos de cÃ¡lculo registrados en el sistema.
...
var URLFuncion = '/datasnap/rest/TCatMetodosCalculoInv/"GetListaMetodosCalculoInv"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/010-GetListaMetodosCalculoInv.pdf)
...
{
"imetodo": "1",
"nmetodo": "Manual (precio asignado por el usuario)",
"ibasadoen": "USER"
}
]
}
