...
> Fuente original: https://www.contapyme.com/api/040_INVENTARIOS/010_Catalogos/020_GruposInv/010-GetListaGrupoInv.html

Â¿CÃ³mo obtener la lista grupal del inventario?

GetListaGrupoInv (datajson, controlkey, iapp, random) : json
...
Retorna un Json con el listado de grupos de inventarios.
...
var URLFuncion = '/datasnap/rest/TCatGrupoInv/"GetListaGrupoInv"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/010-GetListaGrupoInv.pdf)
