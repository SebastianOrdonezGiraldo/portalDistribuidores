...
> Fuente original: https://www.contapyme.com/api/040_INVENTARIOS/010_Catalogos/020_GruposInv/090-DoEliminarGrupoInv.html

Â¿CÃ³mo hacer la eliminaciÃ³n de un grupo del inventario?

DoEliminarGrupoInv (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de eliminar un grupo de inventario de la base de datos, esta función se debe ejecutar en dos pasos, así:
...
Retorna un Json con la confirmaciÃ³n de la eliminaciÃ³n de un grupo de inventario.
...
var URLFuncion = '/datasnap/rest/TCatGrupoInv/"DoEliminarGrupoInv"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/090-DoEliminarGrupoInv.pdf)
...
- 200: El grupo de inventario no se puede eliminar.

Especificas[Ir arriba](#arriba)

- 1005: Ingrese la acciÃ³n que desea ejecutar "Verificar" grupo de inventario Ã³ "Eliminar" grupo de inventario.
