...
> Fuente original: https://www.contapyme.com/api/040_INVENTARIOS/010_Catalogos/030_LineasProductos/080-DoEliminarLineaProductos.html

Â¿CÃ³mo hacer la eliminaciÃ³n de una linea de productos?

DoEliminarLineaProductos (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de eliminar una línea de productos de la base de datos, esta función se debe ejecutar en dos pasos, así:
...
Retorna un Json con la confirmaciÃ³n de la eliminaciÃ³n de una lÃ­nea de productos.
...
var URLFuncion = '/datasnap/rest/TCatLineasProductos/"DoEliminarLineaProductos"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/080-DoEliminarLineaProductos.pdf)
...
| respuesta | JSON | Json que contiene en su interior el objeto “datos” que se describe a continuación:  **eliminar (varchar):** resultado del primer llamado de la función, contiene true cuando la línea de productos se puede eliminar o false cuando no es posible eliminarla.  **eliminado (varchar):** resultado del segundo llamado de la función, contiene true cuando la línea de productos se eliminó satisfactoriamente o false cuando no se pudo eliminar. |
...
- 50: El usuario no posee permisos para: âeliminar el departamento o lineaâ.
- 130: No se ingresÃ³ el parÃ¡metro "X".
- 200: El departamento o lÃ­nea no se puede eliminar.

Especificas[Ir arriba](#arriba)

- 1005: Ingrese la acciÃ³n que desea ejecutar "Verificar" departamento o lÃ­nea Ã³ "Eliminar" departamento o linea.
