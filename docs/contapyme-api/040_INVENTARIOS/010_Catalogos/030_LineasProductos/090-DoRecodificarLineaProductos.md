...
> Fuente original: https://www.contapyme.com/api/040_INVENTARIOS/010_Catalogos/030_LineasProductos/090-DoRecodificarLineaProductos.html

Â¿CÃ³mo hacer la recodificaciÃ³n de una linea de producto?

DoRecodificarLineaProductos (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de recodificar una línea de productos, es decir, cambia el código de identificación de la línea tanto en el catálogo de Departamento o líneas de productos como en las operaciones en las que esté relacionado.

#### Resultado

Retorna un Json con la confirmaciÃ³n de la recodificaciÃ³n de los datos de una lÃ­nea de productos.
...
| --- | --- | --- | --- |
| dataJSON | JSON | Json que contiene en su interior la siguiente estructura.  **idepinv:** Código actual del departamento o línea de productos a recodificar. **(requerido)** **newidepinv:** Nuevo código que se asignará al departamento o línea de productos. (requerido) | { "idepinv": "0624", "newidepinv": "0874" } |
...
var URLFuncion = '/datasnap/rest/TCatLineasProductos/"DoRecodificarLineaProductos"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/090-DoRecodificarLineaProductos.pdf)
...
| respuesta | JSON | Json que contiene en su interior el objeto “datos” que se describe a continuación:  **recodificar (varchar):** contiene true cuando la línea de productos se recodifica satisfactoriamente y false cuando no se pudo recodificar. |
...
- 50: El usuario no posee permisos para: ârecodificar el departamento o lÃ­neaâ.
- 130: No se ingresÃ³ el parÃ¡metro "X".
- 190: El departamento o lÃ­nea no existe.
- 210: El nuevo idepinv no es vÃ¡lido.
