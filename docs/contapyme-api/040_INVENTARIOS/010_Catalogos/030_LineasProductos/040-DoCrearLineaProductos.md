...
> Fuente original: https://www.contapyme.com/api/040_INVENTARIOS/010_Catalogos/030_LineasProductos/040-DoCrearLineaProductos.html

Â¿CÃ³mo hacer la creaciÃ³n de las lineas de productos?

DoCrearLineaProductos (datajson, controlkey, iapp, random) : json
...
Función encargada de registrar toda la información de una línea de productos en la base de datos. Esta función retorna true cuando la línea se crea satisfactoriamente o false cuando no se puede crear.  
...
Retorna un Json con la confirmaciÃ³n de la creaciÃ³n de la lÃ­nea de productos
...
| --- | --- | --- | --- |
| dataJSON | JSON | Json que contiene en su interior toda la información de la línea de productos que se registrará en la base de datos, la información debe ir agrupada en la sección “infobasica”.  **idepinv:** Identificador del departamento o línea de productos a crear. (requerido).  **infobasica:** Contiene la información básica o principal del departamento o línea de productos, en este caso solo es el nombre de la línea pues los demás datos se asignan automáticamente en el Agente. | { "idepinv": "0254", "infobasica": { "ndepinv": "Impresoras lÃ¡ser " } } |
...
var URLFuncion = '/datasnap/rest/TCatLineasProductos/"DoCrearLineaProductos"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/040-DoCrearLineaProductos.pdf)
...
| respuesta | JSON | Json que contiene en su interior el objeto “datos” que se describe a continuación:  **crear (varchar):** Contiene true cuando la línea de productos se crea satisfactoriamente y false cuando la línea no se pueda crear. |
