...
> Fuente original: https://www.contapyme.com/api/040_INVENTARIOS/010_Catalogos/030_LineasProductos/020-GetListaSeleccion.html

Â¿CÃ³mo obtener la lista de las lineas de selecciÃ³n?

GetListaLineasSeleccion (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de retornar un listado de líneas de productos registradas en el sistema, generalmente retorna de cada línea el código y el nombre.   
...
Retorna un Json con el listado de lÃ­neas de productos registradas en el sistema.
...
var URLFuncion = '/datasnap/rest/TCatLineasProductos/"GetListaSeleccion"/';
