...
> Fuente original: https://www.contapyme.com/api/040_INVENTARIOS/010_Catalogos/030_LineasProductos/050-SetInfoLineaProductos.html

Â¿CÃ³mo establecer la informaciÃ³n de las lineas de productos?

SetInfoLineaProductos (datajson, controlkey, iapp, random) : json
...
Retorna un Json con la confirmaciÃ³n de la modificaciÃ³n de los datos de una lÃ­nea de productos.
...
| --- | --- | --- | --- |
| dataJSON | JSON | Json que contiene en su interior la siguiente estructura.  **idepinv:** Identificador del departamento o línea de productos. (requerido).  **infobasica:** Contiene la información básica o principal del departamento o línea de productos, en este caso el único campo que contendría es el nombre de la línea (único dato modificable). | { "idepinv": "0641", "infobasica": { "ndepinv": "Impresoras" } } |
...
var URLFuncion = '/datasnap/rest/TCatLineasProductos/"SetInfoLineaProductos"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/050-SetInfoLineaProductos.pdf)
...
| respuesta | JSON | Json que contiene en su interior el objeto “datos” que se describe a continuación:  **modificar (varchar):** contiene true cuando la línea de productos se modifica satisfactoriamente y false cuando no se pudo modificar. |
