...
> Fuente original: https://www.contapyme.com/api/040_INVENTARIOS/010_Catalogos/010_ElemInv/170-GetListAfectaCuenta.html

Â¿CÃ³mo obtener la lista de las cuentas afectadas?

GetListAfectaCuenta (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de retornar la lista de opciones de afectación de cuentas que se pueden manejar en elementos de inventario compuestos.
...
Retorna un Json con el listado de acciones relacionadas con la afectaciÃ³n de cuentas en el manejo de elementos de inventario compuestos.
...
var URLFuncion = '/datasnap/rest/TCatElemInv/"GetListAfectaCuenta"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/170-GetListAfectaCuenta.pdf)
...
{
"codigo": "T",
"descripcion": "Afectar la cuenta del padre (cuenta de Ã©ste elemento compuesto)"
},
{
"codigo": "F",
"descripcion": "Afectar la cuenta de cada componente (cuenta de cada parte)"
}
]
}
}
...
| respuesta | JSON | Json que contiene en su interior el arreglo de objetos “datos” que se describe a continuación:  **codigo** (**varchar**): Código de la acción a realizar. **descripcion** (**varchar**): Descripción de la acción que realizará el sistema para afectar la cuenta de un elemento compuesto. |
