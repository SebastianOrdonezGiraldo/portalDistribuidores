...
> Fuente original: https://www.contapyme.com/api/040_INVENTARIOS/010_Catalogos/010_ElemInv/100-DoEliminarElemInv.html

Â¿CÃ³mo eliminar un elemento del inventario?

DoEliminarElemInv (datajson, controlkey, iapp, random) : json
...
Retorna un Json con la confirmaciÃ³n de la eliminaciÃ³n de un elemento de inventario.
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/100-DoEliminarElemInv.pdf)
...
| respuesta | JSON | Json que contiene en su interior el objeto “datos” que se describe a continuación:  **eliminar** (**varchar**): resultado del primer llamado de la función, contiene true cuando el elemento de inventario se puede eliminar o false cuando no es posible eliminarlo.  **eliminado** (**varchar**): resultado del segundo llamado de la función, contiene true cuando el elemento de inventario se eliminó satisfactoriamente o false cuando no se pudo eliminar. |
...
- 200: El elemento de inventario no se puede eliminar.

Especificas[Ir arriba](#arriba)

- 1005: Ingrese la acciÃ³n que desea ejecutar "Verificar" elemento Ã³ "Eliminar" elemento.
