...
> Fuente original: https://www.contapyme.com/api/040_INVENTARIOS/010_Catalogos/010_ElemInv/110-DoConsolidarElemInv.html

Â¿CÃ³mo hacer la consolidaciÃ³n de un elemento del inventario?

DoConsolidarElemInv (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de consolidar la información de un elemento de inventario con otro, para poder llamar la función es necesario conocer el código del elemento origen y el código del elemento destino.

#### Resultado

Retorna un Json con la confirmaciÃ³n de la consolidaciÃ³n de los datos de dos elementos de inventario.
...
| --- | --- | --- | --- |
| dataJSON | JSON | Json que contiene en su interior la siguiente estructura:  **irecursoorigen**: Código del elemento de inventario que se quiere consolidar. (requerido) **irecursodestino**: Código del elemento de inventario con el cual se va a consolidar el irecursoorigen. (requerido) | { "irecursoorigen": "01536", "irecursodestino": "016347" } |
...
var URLFuncion = '/datasnap/rest/TCatElemInv/"DoConsolidarElemInv"/';
...
var dataJSON = {
"irecursoorigen": "01536",
"irecursodestino": "016347"
};
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/110-DoConsolidarElemInv.pdf)
...
| respuesta | JSON | Json que contiene en su interior el objeto “datos” que se describe a continuación:  **consolidar** (**varchar**): contiene true cuando el elemento de inventario se consolida satisfactoriamente y false cuando no se pudo consolidar |
