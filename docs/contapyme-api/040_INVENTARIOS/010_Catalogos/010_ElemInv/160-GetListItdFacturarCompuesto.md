...
> Fuente original: https://www.contapyme.com/api/040_INVENTARIOS/010_Catalogos/010_ElemInv/160-GetListItdFacturarCompuesto.html

Â¿CÃ³mo obtener la lista de la factura compuesta?

GetListItdFacturarCompuesto (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de retornar el listado de acciones que puede realizar el sistema al momento de imprimir la factura de un elemento compuesto.  
...
Retorna un Json con el listado de acciones que se pueden realizar cuando se imprima la factura un elemento compuesto
...
var URLFuncion = '/datasnap/rest/TCatElemInv/"GetListItdFacturarCompuesto"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/160-GetListItdFacturarCompuesto.pdf)
...
{
"codigo": "C",
"descripcion": "Facturar solamente el elemento compuesto."
},
{
"codigo": "M",
"descripcion": "Facturar el elemento compuesto discriminando sus partes con precio."
},
{
"codigo": "A",
"descripcion": "Facturar el elemento compuesto discriminando sus partes sin precio."
},
{
"codigo": "P",
"descripcion": "Facturar solamente las partes del elemento compuesto."
},
{
"codigo": "O",
"descripcion": "Facturar el elemento compuesto discriminando en observ., sus partes."
}
]
}
}
...
| respuesta | JSON | Json que contiene en su interior el arreglo de objetos “datos” que se describe a continuación:  **codigo (varchar):** Código de la acción a realizar. **descripcion (varchar):** Descripción de la acción que realizará el sistema cuando se imprima la factura de un elemento compuesto. |
