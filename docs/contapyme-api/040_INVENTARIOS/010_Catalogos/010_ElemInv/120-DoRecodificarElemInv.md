...
> Fuente original: https://www.contapyme.com/api/040_INVENTARIOS/010_Catalogos/010_ElemInv/120-DoRecodificarElemInv.html

Â¿CÃ³mo hacer la recodificaciÃ³n de un elemento del inventario?

DoRecodificarElemInv (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de recodificar un elemento de inventario, es decir, cambia el código de identificación del elemento tanto en el catálogo de elementos de inventario como en las operaciones en las que esté relacionado.

#### Resultado

Retorna un Json con la confirmaciÃ³n de la recodificaciÃ³n de los datos del elemento de inventario.
...
| --- | --- | --- | --- |
| dataJSON | JSON | Json que contiene en su interior la siguiente estructura.  **irecurso**: Código actual del elemento de inventario a recodificar. (requerido) **newirecurso**: Nuevo código que se asignará al elemento de inventario. (requerido) | { "irecurso": "016347", "newirecurso": "016508" } |
...
var URLFuncion = '/datasnap/rest/TCatElemInv/"DoRecodificarElemInv"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/120-DoRecodificarElemInv.pdf)
...
| respuesta | JSON | Json que contiene en su interior el objeto “datos” que se describe a continuación:  **recodificar** (**varchar**): contiene true cuando el elemento de inventario se recodifica satisfactoriamente y false cuando no se pudo recodificar. |
...
- 190: El elemento de inventario no existe.
- 210: El nuevo irecurso no es vÃ¡lido.
