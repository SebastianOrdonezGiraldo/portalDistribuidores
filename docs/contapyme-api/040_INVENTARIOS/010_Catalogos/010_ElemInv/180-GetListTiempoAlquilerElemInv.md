...
> Fuente original: https://www.contapyme.com/api/040_INVENTARIOS/010_Catalogos/010_ElemInv/180-GetListTiempoAlquilerElemInv.html

Â¿CÃ³mo obtener la lista del tiempo de los elementos alquilados?

GetListTiempoAlquilerElemInv (datajson, controlkey, iapp, random) : jsons
...
Esta función es la encargada de retornar el listado de opciones configuradas en el sistema para realizar el cálculo de tiempo cuando se alquila un elemento de inventario.  
...
Retorna un Json con el listado de opciones para el cÃ¡lculo de tiempo de un elemento de alquiler.
...
var URLFuncion = '/datasnap/rest/TCatElemInv/"GetListTiempoAlquilerElemInv"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/180-GetListTiempoAlquilerElemInv.pdf)
...
{
"codigo": "0",
"descripcion": "Minutos configuraciÃ³n 1"
},
{
"codigo": "1",
"descripcion": "Minutos configuraciÃ³n 2"
},
{
"codigo": "2",
"descripcion": "Horas configuraciÃ³n 1"
},
{
"codigo": "3",
"descripcion": "Horas configuraciÃ³n 2"
},
{
"codigo": "4",
"descripcion": "Noches configuraciÃ³n 1"
},
{
"codigo": "5",
"descripcion": "Noches configuraciÃ³n 2"
}
]
}
}
...
| respuesta | JSON | Json que contiene en su interior el arreglo de objetos “datos” que se describe a continuación:  **codigo** (**varchar**): Código de la configuración. **descripcion** (**varchar**): Descripción de la configuración para el cálculo del tiempo de alquiler de un elemento de inventario. |
