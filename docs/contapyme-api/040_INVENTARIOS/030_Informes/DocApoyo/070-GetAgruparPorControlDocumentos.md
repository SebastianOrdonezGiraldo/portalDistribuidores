...
> Fuente original: https://www.contapyme.com/api/040_INVENTARIOS/030_Informes/DocApoyo/070-GetAgruparPorControlDocumentos.html

Â¿CÃ³mo obtener la agrupaciÃ³n por el control de documentos?

GetAgruparPorControlDocumentos (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de retornar el listado de campos disponibles para agrupar la información de los informes de control de documentos del módulo de Inventarios.  
Para poder obtener los campos de cada reporte es necesario enviar el código identificador del reporte (keyaction).

#### Resultado

Retorna un Json con los campos que se pueden utilizar para agrupar la informaciÃ³n de los informes de control de documentos.
...
| --- | --- | --- | --- |
| dataJSON | JSON | Json que contiene en su interior la siguiente **estructura.** **keyaction:** Identificador del reporte. | { "keyaction": "4896" } |
...
var URLFuncion = '/datasnap/rest/TReportes/"GetAgruparPorControlDocumentos"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/070-GetAgruparPorControlDocumentos.pdf)
...
"@:No agrupar",
"INIT:Cliente",
"INITVENDEDOR:Vendedor",
"FDIA:DÃ­a",
"FMes:Mes",
"FAnio:AÃ±o",
"FSEMANA:Semana",
"ICLASIFOP:Clase operaciÃ³n",
"ITDSOP:Tipo de documento soporte",
"ITDOPER:Tipo de operaciÃ³n",
"IProcess\_BAnulada:Estado de la operaciÃ³n"
]
}
}
]
...
| respuesta | JSON | Json que contiene en su interior el arreglo “datos” que se describe a continuación:  **datos (arreglo):** contiene los nombres de los campos por los que se puede agrupar la información de los reportes de control de documentos. Cada posición del arreglo contiene el nombre del campo en la base de datos y separado por “:” la etiqueta del campo. |
