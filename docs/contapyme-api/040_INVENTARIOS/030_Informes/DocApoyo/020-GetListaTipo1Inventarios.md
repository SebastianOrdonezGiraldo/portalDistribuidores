...
> Fuente original: https://www.contapyme.com/api/040_INVENTARIOS/030_Informes/DocApoyo/020-GetListaTipo1Inventarios.html

Â¿CÃ³mo obtener la lista tipo 1 de los inventarios?

GetListaTipo1Inventarios (datajson, controlkey, iapp, random) : json
...
Retorna un Json con el listado de valores del campo Tipo 1 del catÃ¡logo de elementos de inventario.
...
var URLFuncion = '/datasnap/rest/TReportes/"GetListaTipo1Inventarios"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/020-GetListaTipo1Inventarios.pdf)
...
| respuesta | JSON | Json que contiene en su interior el arreglo “datos” que se describe a continuación:  **datos (arreglo):** contiene los valores del campo Tipo 1 del catálogo de elementos de inventario. |
