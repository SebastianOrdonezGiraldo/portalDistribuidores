...
> Fuente original: https://www.contapyme.com/api/040_INVENTARIOS/030_Informes/DocApoyo/010-GetListaClase1Inventarios.html

Â¿CÃ³mo obtener la lista de la clase 1 de inventarios?

GetListaClase1Inventarios (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de retornar el listado de valores que tiene el campo Clase 1 registrados en el sistema, este campo pertenece al catálogo de elementos de inventario.
...
Retorna un Json con el listado de valores del campo Clase 1 de elementos de inventarios.
...
var URLFuncion = '/datasnap/rest/TReportes/"GetListaClase1Inventarios"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/010-GetListaClase1Inventarios.pdf)
...
| respuesta | JSON | Json que contiene en su interior el arreglo “datos” que se describe a continuación:  **datos (arreglo):** contiene los valores existentes para el campo Clase 1 del catálogo de elementos de inventario. |
