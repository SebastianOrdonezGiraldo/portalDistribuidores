...
> Fuente original: https://www.contapyme.com/api/040_INVENTARIOS/030_Informes/DocApoyo/030-GetListaAgruparPorInventarios.html

Â¿CÃ³mo obtener la lista agrupada por el inventario?

GetListaAgruparPorInventarios (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de retornar el listado de opciones por las cuales se puede agrupar la información de los siguientes reportes de inventarios:
...
Retorna un Json con el listado de opciones que se pueden utilizar para agrupar los datos de algunos reportes de Inventarios.
...
var URLFuncion = '/datasnap/rest/TReportes/"GetListaAgruparPorInventarios"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/030-GetListaAgruparPorInventarios.pdf)
...
"Clase 1 (Prod.)",
"Clase 2 (Prod.)",
"Cuenta ingresos (Grupo Inv. o Prod.)",
"Cuenta inventario (Bodega o Prod.)",
"Dato 1 (Prod.)",
"Dato 2 (Prod.)",
"Dato 3 (Prod.)",
"Grupo Inventarios",
...
| respuesta | JSON | Json que contiene en su interior el arreglo “datos” que se describe a continuación:  **datos (arreglo):** contiene los nombres de las opciones que se pueden utilizar para agrupar la información en algunos reportes de Inventarios. |
