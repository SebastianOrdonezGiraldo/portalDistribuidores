...
> Fuente original: https://www.contapyme.com/api/070_ACTIVOS/010_Catalogos/010_CatalogoActivos/010-GetListaSeleccion.html
...
Esta función es la encargada de retornar un listado de activos registrados en el sistema, retorna de cada activo el código y el nombre.   
Esta función se debe utilizar cuando se requiera mostrar un listado de activos en un selector, es decir, una lista de selección en la que el usuario pueda elegir una opción.

#### Resultado

Retorna un Json con un listado de activos registrados en el sistema.
...
| --- | --- | --- | --- |
| dataJSON | JSON | Este Json contiene en su interior la siguiente estructura:  **datospagina:** Json que **contiene:** **cantidadregistros:** cantidad de registros a retornar por página **(requerido)** **pagina:** número de página desde la cual se retornará la información (requerido)  **camposderetorno:** Arreglo que contiene los nombres de los campos de los cuales se desea obtener la información. En este caso son: iactivo y nactivo. (requerido).  **datosfiltro:** Json que contiene la información por la cual se desea filtrar la búsqueda.  (opcional)  **ordenarpor:** Json que contiene la información por la cual se va a ordenar la consulta, se pueden ordenar tanto de forma ascendente como descendente, los campos por los cuales se puede ordenar la consulta son iactivo y nactivo (opcional) | { "datospagina": { "cantidadregistros": 20, "pagina": 1 }, "camposderetorno": [ "iactivo", "nactivo" ], "datosfiltro": { "FSoport": "12-31-2014" }, "ordenarpor": { "iactivo": "asc" } } |
...
var URLFuncion = '/datasnap/rest/TCatActivos/"GetListaSeleccion"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/010-GetListaSeleccion.pdf)
...
{
"iactivo": "2",
"nactivo": "Computador con procesador PIII 750 MHZ"
},
{
"iactivo": "3",
"nactivo": "CompÃºtador con procesador PIII 750 MHZ"
},
{
"iactivo": "4",
"nactivo": "Selladora lineal"
},
{
"iactivo": "6",
"nactivo": "Planta telefÃ³nica alcatel 2750"
},
{
"iactivo": "12",
"nactivo": "MÃ¡quina velobinder metÃ¡lica"
},
{
"iactivo": "21",
"nactivo": "MÃ³dulo EntrepaÃ±o (1)"
},
{
"iactivo": "26",
"nactivo": "Archivo (1)"
