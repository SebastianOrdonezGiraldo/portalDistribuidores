...
> Fuente original: https://www.contapyme.com/api/005_INTRODUCCION/130-Logout.html

Â¿CÃ³mo cerrar sesiÃ³n?

Logout (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de cerrar la sesión del usuario en el Agente, es decir elimina los datos del usuario de la lista de usuarios logueados.

#### Resultado

FunciÃ³n que retorna un json con la confirmaciÃ³n del cierre de sesiÃ³n del usuario.
...
var URLFuncion = '/datasnap/rest/TBasicoGeneral/"Logout"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/130-Logout.pdf)
...
| respuesta | JSON | Json que contiene en su interior el objeto “datos” que se describe a continuación:  **cerro (varchar):** retorna true cuando la sesión se cierra satisfactoriamente o false cuando no se pudo cerrar. |
