...
> Fuente original: https://www.contapyme.com/api/060_COSTOS/030_Informes/DocApoyo/020-GetListaEtapas.html

Â¿CÃ³mo obtener la lista de etapas?

GetListaEtapas (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de retornar el listado de etapas de un centro de costos de producción, disponibles para generar informes de estados financieros por actividad y etapa.

#### Resultado

Retorna un Json con el listado de etapas de los centros de costos de producciÃ³n.
...
var URLFuncion = '/datasnap/rest/TReportes/"GetListaEtapas"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/020-GetListaEtapas.pdf)
...
| respuesta | JSON | Json que contiene en su interior el arreglo “datos” que se describe a continuación:  **datos (arreglo):** Contiene el código y nombre de la etapa del centro de costos, estos dos parámetros van separados por “:” |
