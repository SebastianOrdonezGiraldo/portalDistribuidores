...
> Fuente original: https://www.contapyme.com/api/060_COSTOS/030_Informes/DocApoyo/070-GetCuentaProductoProcesoCC.html

Â¿CÃ³mo obtener la cuenta del producto con el proceso CC?

GetCuentaProductoProcesoCC (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de validar si un centro de costos tiene definida la cuenta de producto en proceso, si es así, retorna el código de dicha cuenta.

#### Resultado

Retorna un Json con el cÃ³digo de la cuenta de producto en proceso que tiene configurada un centro de costos.
...
| --- | --- | --- | --- |
| dataJSON | JSON | Json que contiene en su interior la siguiente estructura  **icc:** código del centro de costos del cual se desea conocer la cuenta de producto en proceso.  **fecharef:** Fecha hasta la cual se generará el reporte. | { "icc": "1160100", "fecharef": "01/01/9999" } |
...
var URLFuncion = '/datasnap/rest/TReportes/"GetCuentaProductoProcesoCC"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/070-GetCuentaProductoProcesoCC.pdf)
...
| respuesta | JSON | Json que contiene en su interior el arreglo “datos” que se describe a continuación:  **icuenta (varchar):** Contiene el código de la cuenta de producto en proceso configurada para el centro de costos. |
