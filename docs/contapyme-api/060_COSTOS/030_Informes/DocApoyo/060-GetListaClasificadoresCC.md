...
> Fuente original: https://www.contapyme.com/api/060_COSTOS/030_Informes/DocApoyo/060-GetListaClasificadoresCC.html

Â¿CÃ³mo obtener la lista de los clasificadores CC?

GetListaClasificadoresCC (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de retornar el listado de clasificadores de centros de costos que se pueden utilizar para generar el informe de: Costos de la producción de actividad empresarial.

#### Resultado

Retorna un Json con el listado de clasificadores que se pueden utilizar al generar algunos reportes de costos.
...
var URLFuncion = '/datasnap/rest/TReportes/"GetListaClasificadoresCC"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/060-GetListaClasificadoresCC.pdf)
...
| respuesta | JSON | Json que contiene en su interior el arreglo “datos” que se describe a continuación:  **datos (arreglo):** Contiene los nombres de los clasificadores. |
