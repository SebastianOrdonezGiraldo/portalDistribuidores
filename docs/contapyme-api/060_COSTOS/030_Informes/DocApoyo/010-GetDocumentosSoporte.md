...
> Fuente original: https://www.contapyme.com/api/060_COSTOS/030_Informes/DocApoyo/010-GetDocumentosSoporte.html

Â¿CÃ³mo obtener los documentos de soporte?

GetDocumentosSoporte (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de retornar un listado de documentos de soporte usados en las operaciones durante un período de tiempo determinado.

Esta función se llama en los informes de:

- Comprobantes de pago por trabajador

- Planilla de pago a trabajadores

#### Resultado

Retorna un Json con la informaciÃ³n de los documentos de soporte usados en las operaciones en un perÃ­odo de tiempo.
...
| --- | --- | --- | --- |
| dataJSON | JSON | Json que contiene en su interior la siguiente estructura.  **fini:** Fecha inicial a partir de la cual se obtendrán los **documentos.** **ffin:** Fecha final hasta la cual se obtendrán los documentos. | { "fini": "01/01/2013", "ffin": "12/31/2013" } |
...
var URLFuncion = '/datasnap/rest/TReportes/"GetDocumentosSoporte"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/010-GetDocumentosSoporte.pdf)
...
{
"codigo": "PT-1302001",
"descripcion": "Doc #PT-1302001,Fecha: 31 / 01 / 2013 "
},
{
"codigo": "PT-1304002",
"descripcion": "Doc # PT-1304002, Fecha: 22 / 02 / 2013 "
},
{
"codigo": "PT-1308003",
"descripcion": "Doc # PT-1308003, Fecha: 18 / 03 / 2013 "
},
{
"codigo": "PT-1312004",
"descripcion": "Doc # PT-1312004, Fecha: 30 / 04 / 2013 "
}
]
}
}
...
| respuesta | JSON | Json que contiene en su interior el arreglo de objetos “datos” que se describe a continuación:  **codigo (varchar):** Número de la operación formateado según la máscara del tipo de documento de **soporte.** **decripcion (varchar):** Descripción del documento de **soporte.** **fecha (varchar):** Fecha de la operación. |
