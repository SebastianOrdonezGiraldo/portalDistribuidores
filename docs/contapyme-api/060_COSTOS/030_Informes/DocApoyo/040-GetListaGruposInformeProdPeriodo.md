...
> Fuente original: https://www.contapyme.com/api/060_COSTOS/030_Informes/DocApoyo/040-GetListaGruposInformeProdPeriodo.html

Â¿CÃ³mo obtener el informe de la lista de grupos de producciÃ³n por periodo?

GetListaGruposInformeProduccionPorPeriodo (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de retorna el listado de opciones por los cuales se puede agrupar la información de los informes de:

- Costos de producción de actividad empresarial
- Producción y ventas semanales
- Producción por periodo

#### Resultado

Retorna un Json con el listado de grupos de centros de costos.
...
var URLFuncion = '/datasnap/rest/TReportes/"GetListaGruposInformeProduccionPorPeriodo"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/040-GetListaGruposInformeProdPeriodo.pdf)
...
| respuesta | JSON | Json que contiene en su interior el arreglo “datos” que se describe a continuación:  **datos (arreglo):** Contiene los nombres de las opciones que se pueden utilizar para agrupar la información de algunos informes de costos. |
