...
> Fuente original: https://www.contapyme.com/api/060_COSTOS/030_Informes/DocApoyo/050-GetListaProducInformesCostos.html

Â¿CÃ³mo obtener la lista de productos por los informes de costos?

GetListaProductosInformesCostos (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de retornar el listado de productos producidos y embodegados en una empresa y hasta una fecha determinada.

Esta función se llama en los informes de:

- Estado de la producción de un centro de costos
- Costos de la producción de un centro de costos
- Costos de la producción de actividad empresarial
- Producción y ventas semanales
- Producción por periodo

#### Resultado

Retorna un Json con el listado de productos producidos y embodegados en una empresa.
...
| --- | --- | --- | --- |
| dataJSON | JSON | Json que contiene en su interior la siguiente estructura.  **iactividad:** Actividad empresarial para la cual se obtendrán los productos **producidos.** **fecharef:** Fecha de referencia hasta la cual se obtendrán los productos producidos y **embodegados.** **bembodegados (varchar):** Indica si se deben retornar también los productos embodegados. | { "iactividad": "2", "fecharef": "04/30/2014", "bembodegados": "F" } |
...
var URLFuncion = '/datasnap/rest/TReportes/"GetListaProductosInformesCostos"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/050-GetListaProducInformesCostos.pdf)
...
| respuesta | JSON | Json que contiene en su interior el arreglo “datos” que se describe a continuación:  **datos (arreglo):** Contiene los nombres de los productos producidos en la empresa a una fecha determinada. |
