...
> Fuente original: https://www.contapyme.com/api/060_COSTOS/030_Informes/DocApoyo/030-GetListaCiclosCostosPorICC.html

Â¿CÃ³mo obtener la lista de ciclos de costos por su ICC?

GetListaCiclosCostosPorICC (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de retornar el listado de ciclos de costos que tiene un centro de costos hasta una fecha dada. Para los informes de costos de producción, se deben pedir los ciclos en etapa de producción; y para los informes de costos de desarrollo, los ciclos en etapa de desarrollo.

#### Resultado

Retorna un Json con el listado de ciclos de costos que tiene un centro de costos.
...
| --- | --- | --- | --- |
| dataJSON | JSON | Json que contiene en su interior la siguiente estructura.  **icc:** Código del centro de costos para el cual se obtendrán los **ciclos.** **ietapa:** Etapa para la cual se obtendrán los ciclos de costos. Puede ser 2 – En desarrollo, 3 – En producción.  **fsoport:** Fecha hasta la cual se obtendrán los ciclos de costos. | { "icc": "10103", "ietapa": "3", "fsoport": "04-10-2014" } |
...
var URLFuncion = '/datasnap/rest/TReportes/"GetListaCiclosCostosPorICC"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/030-GetListaCiclosCostosPorICC.pdf)
...
"respuesta": {
"datos": [
"1.1|# 1.1, Inicio: 31/12/2003 - Fin: 01/01/9999"
]
}
}
]
...
| respuesta | JSON | Json que contiene en su interior el arreglo “datos” que se describe a continuación:  **datos (arreglo):** Contiene el código del ciclo de costos junto con su fecha inicial y final. |
