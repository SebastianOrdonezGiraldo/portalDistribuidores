...
> Fuente original: https://www.contapyme.com/api/020_CONTABILIDAD/010_Catalogos/010_Estados_financieros/110-DoEliminarFavoritoCuentas.html

Â¿CÃ³mo hacer la eliminaciÃ³n de una cuenta favorita?

DoEliminarFavoritoCuentas (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de eliminar una cuenta favorita, es decir la borra de las cuentas favoritas pero sigue como una cuenta del plan de cuentas.

#### Resultado

Retorna un Json con la confirmaciÃ³n de la eliminaciÃ³n de una cuenta favorita
...
| --- | --- | --- | --- |
| dataJSON | JSON | Json que contiene en su interior la siguiente estructura.  **idato**: Identificador del favorito a eliminar. | { "idato": "10" } |
...
var URLFuncion = '/datasnap/rest/TEstadosFinancieros/"DoEliminarFavoritoCuentas"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/110-DoEliminarFavoritoCuentas.pdf)
...
| respuesta | JSON | Json que contiene en su interior el arreglo “datos” que se describe a continuación.  **datos (arreglo):** Contiene true cuando el favorito se pudo eliminar satisfactoriamente y false cuando no se pudo eliminar. |
