...
> Fuente original: https://www.contapyme.com/api/020_CONTABILIDAD/010_Catalogos/010_Estados_financieros/100-SetCategoriaFavorita.html

Â¿CÃ³mo establecer las categorias favoritas?

SetCategoriaFavorita (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de renombrar una categoría de favoritos financieros en la base de datos.

#### Resultado

Retorna un Json con la confirmaciÃ³n del renombramiento de una categorÃ­a de favoritos financieros.
...
| --- | --- | --- | --- |
| dataJSON | JSON | Json que contiene en su interior la siguiente estructura.  **oldcategoria:** Nombre de la categoría que se va a renombrar. **newcategoria:** Nuevo nombre que se le va a dar a la categoría. | { "oldcategoria": "Ingresos por ventas de PCs", "newcategoria": "Ingresos por venta de equipos de cÃ³mputo" } |
...
var URLFuncion = '/datasnap/rest/TEstadosFinancieros/"SetCategoriaFavorita"/';
...
var dataJSON = {
"oldcategoria": "Ingresos por ventas de PCs",
"newcategoria": "Ingresos por venta de equipos de cÃ³mputo"
};
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/100-SetCategoriaFavorita.pdf)
...
| respuesta | JSON | Json que contiene en su interior el arreglo “datos” que se describe a continuación.  **datos (arreglo):** Contiene true cuando la categoría se renombra satisfactoriamente o false cuando no se puede renombrar |
