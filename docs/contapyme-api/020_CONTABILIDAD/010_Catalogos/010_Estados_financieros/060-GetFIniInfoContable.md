...
> Fuente original: https://www.contapyme.com/api/020_CONTABILIDAD/010_Catalogos/010_Estados_financieros/060-GetFIniInfoContable.html

Â¿CÃ³mo obtener la informaciÃ³n contable?

GetFIniInfoContable (datajson, controlkey, iapp, random) : json
...
Esta función es la encargada de retornar la fecha de inicio de registro de la información contable de la empresa a la que se encuentra conectado el usuario.

#### Resultado

Retorna un Json con la fecha de inicio de registro de informaciÃ³n contable de la empresa
...
var URLFuncion = '/datasnap/rest/TEstadosFinancieros/"GetFIniInfoContable"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/060-GetFIniInfoContable.pdf)
...
| respuesta | JSON | Json que contiene en su interior el arreglo “datos” que se describe a continuación  **datos (arreglo)**: Contiene la fecha de inicio de registro de la información contable de la empresa. |
