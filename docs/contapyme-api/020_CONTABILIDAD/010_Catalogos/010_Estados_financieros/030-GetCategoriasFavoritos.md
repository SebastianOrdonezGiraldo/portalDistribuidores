...
> Fuente original: https://www.contapyme.com/api/020_CONTABILIDAD/010_Catalogos/010_Estados_financieros/030-GetCategoriasFavoritos.html

Â¿CÃ³mo obtener la categoria favorita?

GetCategoriasFavoritos (datajson, controlkey, iapp, random) : json
...
Retorna un Json con el listado de categorÃ­as de cuentas favoritas del usuario.
...
var URLFuncion = '/datasnap/rest/TEstadosFinancieros/"GetCategoriasFavoritos"/';
...
Ver documentaciÃ³n de la peticiÃ³n por [GET.](PDFS/030-GetCategoriasFavoritos.pdf)
...
| respuesta | JSON | Json que contiene en su interior el arreglo de objetos “datos” que se describe a continuación:  **categoría (varchar)**: Nombre de la categoría de favoritos **idinternoperfil (varchar)**: Código identificador del perfil del usuario que inicia la sesión, cada categoría está asociada a un perfil. |
