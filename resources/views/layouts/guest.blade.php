...
<head>
    ...
    @stack('head')
    @vite(['resources/css/public.css', 'resources/js/core-public.js'])
</head>
<body>
    ...
    <div class="hidden flex-col justify-between border-r border-slate-200 bg-brand-ink px-10 py-8 text-white lg:flex lg:w-[42%] xl:w-[40%]">
        <div>
            <div class="flex items-center gap-3">
                <img src="{{ asset('images/import-corporal-logo.png') }}" alt="Import Corporal Medical SAS" width="447" height="191" class="h-10 w-auto">
                <div>
