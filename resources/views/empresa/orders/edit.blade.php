<x-app-layout>
    ...
    <x-slot name="header">
        <x-ui.page-header
            ...
            subtitle="Ajusta datos comerciales y cantidades antes de continuar el proceso."
        >
            <x-slot name="actions">
    ...
    <form action="{{ route('empresa.orders.update', $order) }}" method="POST" class="grid gap-4 lg:grid-cols-[1.7fr_1fr]">
        ...
        <x-ui.card class="p-5 lg:row-span-2">
            ...
            <div class="mt-4 border-t border-slate-200 pt-4">
                ...
                <p class="mt-1 text-xs text-slate-500">El total final se recalcula al guardar.</p>
            </div>
