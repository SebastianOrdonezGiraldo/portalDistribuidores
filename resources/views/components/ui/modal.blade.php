...
<div id="{{ $id }}" data-modal {{ $attributes->merge(['class' => 'fixed inset-0 z-[70] hidden items-end justify-center bg-slate-950/55 p-3 sm:items-center sm:p-4']) }} role="dialog" aria-modal="true" aria-hidden="true" aria-labelledby="{{ $id }}-title" tabindex="-1">
