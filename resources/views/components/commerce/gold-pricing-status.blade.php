        ...
        <div class="commerce-status-row__head">
            ...
            <div class="min-w-0">
                ...
                <p class="mt-0.5 text-xs text-slate-500">
                    Tu pedido ya alcanzó el monto requerido y ahora aplica precios Oro.
                </p>
            </div>
        </div>
    </div>
    ...
    <div {{ $attributes->class('commerce-status-row') }}>
        <div class="commerce-status-row__head">
            ...
            <div class="min-w-0 flex-1">
                <p class="text-sm font-semibold text-slate-900">Activa tus precios Oro</p>
                <p class="mt-1 text-sm font-bold text-amber-800">
                    Agrega {{ $moneyFromCents($missing) }} más para alcanzar {{ $moneyFromCents($amount) }}.
                </p>
                <p class="mt-1 text-xs font-semibold text-slate-700">
                    Si continúas ahora, este pedido se procesará con precios Plata.
                </p>
            </div>
        </div>
